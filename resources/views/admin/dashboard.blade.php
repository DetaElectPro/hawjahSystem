...
@section('content')
    ...
    <div class="row tile_count">
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user-times "></i>Emergency Servers</span>
            <div>
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-lock"></i>Pharmacy Request</span>
            <div>
                <span class="count red">{{  $counts['pharmacy'] }}</span>
            </div>
        </div>
    </div>
    <!-- /top tiles -->
