            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="status" type="number"
                           class="form-control col-md-7 col-xs-12 @if($errors->has('status')) parsley-error @endif"
                        ...
                        <div class="checkbox">
                            <label>
                                <input id="active" type="checkbox"
                                       class="@if($errors->has('active')) parsley-error @endif"
                        ...
                        <div class="checkbox">
                            <label>
                                <input id="confirmed" type="checkbox"
                                       class="@if($errors->has('confirmed')) parsley-error @endif"
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select id="roles" name="roles[]" class="select2" multiple="multiple" style="width: 100%"
                        ...
                        @foreach($roles as $role)
                            <option @if($user->roles->find($role->id)) selected="selected"
