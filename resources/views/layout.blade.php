            ...
            <li class="nav-item">
                ...
                <div id="collapseMedical" class="collapse" aria-labelledby="headingMedical"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('medical_fields.index')}}">Medical Fields</a>
                        <a class="collapse-item" href="{{route('medical_fields.create')}}">Add Medical Field</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Medical Specialists</h6>
                        <a class="collapse-item" href="{{route('medical_specialists.index')}}">Specialists</a>
                        <a class="collapse-item" href="{{route('medical_specialists.create')}}">Add Specialists</a>
                    </div>
                </div>
            </li>
